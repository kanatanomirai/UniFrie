// This code was created with reference to https://gist.github.com/darktable/2317063 .
...
public class SavWav
{
    ...
    public byte[] GetVoiceBinaryData(AudioClip clip)
    {
        ...
        Byte[] bytesData = new Byte[clipdata.samplesData.Length * 2];
    ...
    byte[] Convert(ClipData clipData)
    {
    ...
    private byte[] AddWavHeader(byte[] bytes)
    {
        ...
        header[32] = (byte)((bits / 2) * channels);
        header[33] = 0;
        header[34] = (byte)bits;
        header[35] = 0;
