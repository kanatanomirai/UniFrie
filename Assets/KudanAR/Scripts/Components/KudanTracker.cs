...
//					_trackerPlugin.SetApiKey (_APIKey, Application.bundleIdentifier);
		...
		/// 現在のトラッキングメソッドを指定されたトラッキングメソッドに変更します。
		/// </summary>
		...
		/// <summary>
		/// Start ArbiTrack on the current platform.ArbiTrackを現在のプラットフォームで起動します。
		/// </summary>
		...
		/// 現在のデバイスの位置と向きを取得します。
		/// </summary>
		/// <param name="position">Position of the floor, relative to the camera.カメラに対する床の位置。</param>
		/// <param name="orientation">Orientation of the floor, relative to the camera.カメラに対する床の向き。</param>
